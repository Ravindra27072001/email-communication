<template>
    <div>
        ...
        <div class="pt-5">
            <h1 class="mb-3 pb-3 text-center fw-bolder text-dark">Schedule Group Meeting 👥 </h1>
            <div class="d-flex justify-content-center m-3">

                <router-link to="/sendEmail" class="text-decoration-none">
                    <button class="btn bg-info">for everyone</button>
                </router-link>

                <router-link to="/sendEmailIndividual" class="text-decoration-none">
                    <button class="btn bg-secondary ms-5">for individual</button>
                </router-link>
                ...
                <div class="col col-xl-8">
                    <div class="tables m-auto" id="newClass">
                        ...
                        <form class="p-3" @submit.prevent="submit">
                            ...
                            <div class="form-outline mt-2 w-50">
                                <label class="form-label text-white" for="form-control">Meeting Link
                                    <a target="_blank" href="https://meet.google.com/"><img id="meet-logo" src="../images/meet-logo.jpg" alt=""></a>create link</label>
                                <input type="url" class="form-control" v-model.trim="meetingLink" name="meetingLink" />
                                <div class="invalid-feedback">
                                    <span v-if="!$v.to.meetingLink">Required</span>
                                </div>
